[LastAttempt-a89c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [LastAttempt-a89c] container is NOT running**.

.. tip::
   You must have your [LastAttempt-a89c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Hooluwole/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46171  \-\-env VIPERVIZPORT=40489  \-\-env GITUSERNAME='Hooluwole'  \-\-env DOCKERUSERNAME='hooluwole70'  \-\-env MQTTUSERNAME='hooluwole70'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:40489/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:40489/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   hooluwole70/LastAttempt-a89c-amd64 (https://hub.docker.com/r/hooluwole70/LastAttempt-a89c-amd64)
...
.. important::
   docker run -d -p 33761:33761 -p 37637:37637 -p 38937:38937 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=LastAttempt-a89c \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-LastAttempt-a89c \-\-env GITUSERNAME=Hooluwole  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi \-\-env SOLUTIONEXTERNALPORT=33761  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=37637  \-\-env SOLUTIONVIPERVIZPORT=38937 \-\-env DOCKERUSERNAME='hooluwole70' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=46171 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=40489 \-\-env MQTTUSERNAME='hooluwole70' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole70/LastAttempt-a89c-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=38937
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=33761
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hooluwole70/LastAttempt-a89c-amd64
...
It can be accessed by entering: http://localhost:37637
...
.. important::
   http://localhost:38937/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:38937/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:38937/<html file>
...
[LastAttempt-a89c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Hooluwole/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/LastAttempt-a89c
...
.. important::
   https://LastAttempt-a89c.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-LastAttempt-a89c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=33761, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39575, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=40541, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33015, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36249, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37065, HPDEHOST=127.0.1.1, HPDEPORT=44135, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35453

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8933-LastAttempt-a89c,solution_preprocessing_ai_mqtt_dag-LastAttempt-a89c, python-preprocess-6691-LastAttempt-a89c,solution_preprocessing_ai_mqtt_dag-LastAttempt-a89c, python-ai-7274-LastAttempt-a89c,solution_preprocessing_ai_mqtt_dag-LastAttempt-a89c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
